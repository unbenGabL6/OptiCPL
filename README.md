...
Download data and pretrained models from: https://huggingface.co/Zylqaq/OptiCPL
...
**Training data**: `Data/DF_IMG.xlsx` (200-dim features + 8 targets)
...
│   └── Optical Model → Optical Features (32-dim)
├── glum (40-dim)
│   └── Pass-through
...
| `--raw-data` | Input raw data file (raw-pipeline mode) | `Data/Data_complete_corrected_v7.xlsx` |
| `--img-dir` | SEM images directory (raw-pipeline mode) | `Data/SEM_ALL/` |
| `--optical-model` | Optical model path (raw-pipeline mode) | `Checkpoints/Pretrained/Spec/Spec_model.pth` |
| `--img-model` | SimCLR model path (raw-pipeline mode) | `Checkpoints/Pretrained/IMG/trained_resnet18_simclr2.pth` |
...
- **File**: `Data/DF_IMG.xlsx`

**Raw Data Pipeline**:
- **Raw data file**: `Data/Data_complete_corrected_v7.xlsx`
...
- SEM images: three images from different angles in `Data/SEM_ALL/`
...
│   └── stage2/              # Copies of Optical/SimCLR models
