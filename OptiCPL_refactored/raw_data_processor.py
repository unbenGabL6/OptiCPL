...
from .optical_model import load_optical_model, extract_optical_features, min_max_scale
...
def process_raw_data(file_path: str, optical_model_path: str, img_model_path: str,
    ...
    Args:
        ...
        optical_model_path: Path to optical feature extractor model
    ...
    # Step 3: Generate Optical features
    print("\n[Step 3] Generating Optical features...")
    optical_model = load_optical_model(optical_model_path, device)
    optical_features = extract_optical_features(optical_model, df, device, batch_size)
